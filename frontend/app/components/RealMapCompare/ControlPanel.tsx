        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col xl:flex-row gap-2">
              ...
              >
                <SelectTrigger className="flex-1 bg-slate-50 h-10 border-slate-200">
              ...
              <Button
                ...
                className="bg-blue-50 text-blue-600 hover:bg-blue-100 border border-blue-200 h-10 px-3"
              >
                {loadingGraph ? (
            ...
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-100 text-sm h-17 flex flex-col justify-center relative overflow-hidden">
              {loadingGraph ? (
          ...
          <div className="space-y-4 md:border-l border-slate-100 md:pl-6 pt-4 md:pt-0 border-t md:border-t-0">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-emerald-100 text-emerald-600 font-bold flex items-center justify-center text-sm shrink-0">
                  1
                </div>
                <div className="flex-1 p-2 rounded-lg bg-slate-50 border border-slate-200 text-sm flex items-center justify-between">
                  ...
                  <span className="font-mono text-slate-700 font-semibold text-[13px]">
                    {realStart
                      ? `${realStart.lat.toFixed(5)}, ${realStart.lon.toFixed(5)}`
                      : "Click bản đồ"}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-red-100 text-red-600 font-bold flex items-center justify-center text-sm shrink-0">
                  2
                </div>
                <div className="flex-1 p-2 rounded-lg bg-slate-50 border border-slate-200 text-sm flex items-center justify-between">
                  <span className="text-slate-500 font-medium text-sm ml-1">
                  ...
                  <span className="font-mono text-slate-700 font-semibold text-[13px]">
                    {realGoal
                      ? `${realGoal.lat.toFixed(5)}, ${realGoal.lon.toFixed(5)}`
                      : "Click bản đồ"}
                  </span>
                </div>
              </div>
          ...
          <div className="space-y-4 xl:border-l border-slate-100 xl:pl-6 pt-4 xl:pt-0 border-t xl:border-t-0">
            ...
            <div className="space-y-3">
              <div className="bg-slate-50 px-3 rounded-xl border border-slate-200 h-11.25 flex items-center gap-3">
                <label className="text-[13px] font-bold text-slate-500 uppercase whitespace-nowrap">
                  Heuristic (A*)
                </label>
              ...
              <div className="bg-slate-50 px-3 rounded-xl border border-slate-200 h-11.25 flex items-center gap-3">
                ...
                <span className="text-[13px] font-bold text-indigo-600 w-6 text-right">
                  {animationSpeed}x
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3 flex-1 flex flex-col justify-start">
              <div className="flex items-center gap-2">
                <Button
                  ...
                  size="icon"
                  onClick={handleReset}
                  className="h-10 w-10 shrink-0 bg-slate-50 border-slate-200 text-slate-600 hover:text-red-600 hover:bg-red-50 hover:border-red-200 transition-colors"
                  title="Làm mới"
                >
                ...
                <Button
                  ...
                  disabled={
                    loading || !realStart || !realGoal || !osmStats.loaded
                  }
              ...
              {result ? (
                <div className="flex items-center justify-between gap-1 bg-slate-50 p-2 rounded-xl border border-slate-200 animate-in fade-in slide-in-from-bottom-2 duration-300">
                  <div className="flex items-center gap-1">
                    <Button
                      variant="secondary"
                      size="icon"
                      className="h-8 w-8 rounded-full bg-indigo-100 text-indigo-600 hover:bg-indigo-200"
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <div className="text-[13px] font-bold text-slate-600 bg-white px-2 py-1 rounded border border-slate-200 shadow-sm w-10 text-center">
                      {Math.min(
                        ...
                        Math.round(
                          (animationProgress /
                            Math.max(1, totalAnimationNodes)) *
                            100,
                        ),
                      )}
                      %
                ...
                <div className="h-11.5 border border-dashed border-slate-200 rounded-xl flex items-center justify-center text-sm text-slate-400 font-medium bg-slate-50/50">
